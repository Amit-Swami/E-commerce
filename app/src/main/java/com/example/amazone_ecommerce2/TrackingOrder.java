...
import com.example.amazone_ecommerce2.Common.DirectionJSONParser;
import com.example.amazone_ecommerce2.Remote.IGeoCoordinates;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void drawRoute(final LatLng yourLocation, String address) {
        mService.getGeoCode(address, "AIzaSyAk2_ohELRrOepgIYNLHxu2o9nC93T-C3Y").enqueue(new Callback<String>() {
            @Override
