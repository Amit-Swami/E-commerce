...
import com.example.amazone_ecommerce2.Model.Banner;
import com.example.amazone_ecommerce2.Model.Product;
import com.example.amazone_ecommerce2.ViewHolder.BannerViewHolder;
...
public class BannerActivity extends AppCompatActivity {
    ...
    private void showUpdateBannerDialog(final String key, final Banner item) {
        ...
        edtName=edit_banner.findViewById(R.id.edtProductName);
        edtProductId=edit_banner.findViewById(R.id.edtProductId);
